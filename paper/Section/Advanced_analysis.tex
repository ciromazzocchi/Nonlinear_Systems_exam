...
\input{Proofs/PWS-Crossing_region}

\input{Proofs/PWS_Attraction_region}

Given previous Lemma, following Theorem is verified

\input{Proofs/PWM_Classification_surface_regione}
...
\input{Proofs/Equilibria_Lockdown}

\input{Proofs/PWS-Sliding_surface_equilibria}
...
\input{Proofs/PWS-R0_case_1_equilibria}

\input{Proofs/PWS-R0_case_2_equilibria}

\input{Proofs/PWS-R0_case_3_equilibria}
...
\input{Proofs/PWS-Bifurcation_Point}
...
\input{Proofs/PWS-Bifurcation_fold}
